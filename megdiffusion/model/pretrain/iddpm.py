...
converted = [
    ...
    "iddpm_imagenet64_uncond_100M_1500K_converted",
]
...
@hub.pretrained("https://data.megengine.org.cn/research/megdiffusion/iddpm_imagenet64_uncond_100M_1500K_converted.pkl")
def iddpm_imagenet64_uncond_100M_1500K_converted(**kwargs):
    """The deault model configuration used in IDDPM paper on CIFAR10 dataset.
    Ported from: https://openaipublic.blob.core.windows.net/diffusion/march-2021/imagenet64_uncond_100M_1500K.pt
    """
    model = _iddpm_unet_default_config(resolution=64, learn_sigma=True)
    model.diffusion_config = _iddpm_diffusion_default_config()
    model.channel_order = "RGB"
    return model